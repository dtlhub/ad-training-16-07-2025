...
<div class="card">
<h3><i class="fas fa-sitemap"></i> Предложить открытую публикацию</h3>
    <form action="postPub.php" method="POST">
    Publication: <input type="text" name="pubtext" required><br><br>
